...
func TestScanSymbol_0(t *testing.T) {
	in := `<-`
	exp := dummySymToken(2, `<-`, token.TK_ASSIGN)
...
func TestScanSymbol_4(t *testing.T) {
	in := `+`
	exp := dummySymToken(1, `+`, token.TK_ADD)
	doTestScanSymbol(t, in, exp, nil)
}

func TestScanSymbol_5(t *testing.T) {
	in := `-`
	exp := dummySymToken(1, `-`, token.TK_SUBTRACT)
	doTestScanSymbol(t, in, exp, nil)
}

func TestScanSymbol_6(t *testing.T) {
	in := `*`
	exp := dummySymToken(1, `*`, token.TK_MULTIPLY)
	doTestScanSymbol(t, in, exp, nil)
}

func TestScanSymbol_7(t *testing.T) {
	in := `/`
	exp := dummySymToken(1, `/`, token.TK_DIVIDE)
	doTestScanSymbol(t, in, exp, nil)
}

func TestScanSymbol_8(t *testing.T) {
	in := `%`
	exp := dummySymToken(1, `%`, token.TK_MODULO)
	doTestScanSymbol(t, in, exp, nil)
}
...
func TestScanSymbol_10(t *testing.T) {
	in := `_`
	exp := dummySymToken(1, `_`, token.TK_VOID)
	doTestScanSymbol(t, in, exp, nil)
}

func TestScanSymbol_11(t *testing.T) {
	in := `,`
	exp := dummySymToken(1, `,`, token.TK_DELIM)
	doTestScanSymbol(t, in, exp, nil)
}
