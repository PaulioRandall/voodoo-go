	...
	return []scanLineTest{
		...
		scanLineTest{
			...
			Expect: []symbol.Lexeme{
				...
				symbol.Lexeme{`(`, 16, 17, 0, symbol.PAREN_CURVY_OPEN},
				symbol.Lexeme{`a`, 17, 18, 0, symbol.IDENTIFIER_EXPLICIT},
				symbol.Lexeme{`,`, 18, 19, 0, symbol.SEPARATOR_VALUE},
				symbol.Lexeme{` `, 19, 20, 0, symbol.WHITESPACE},
				symbol.Lexeme{`b`, 20, 21, 0, symbol.IDENTIFIER_EXPLICIT},
				symbol.Lexeme{`)`, 21, 22, 0, symbol.PAREN_CURVY_CLOSE},
				symbol.Lexeme{` `, 22, 23, 0, symbol.WHITESPACE},
				symbol.Lexeme{`r`, 23, 24, 0, symbol.IDENTIFIER_EXPLICIT},
				symbol.Lexeme{`,`, 24, 25, 0, symbol.SEPARATOR_VALUE},
				symbol.Lexeme{` `, 25, 26, 0, symbol.WHITESPACE},
				symbol.Lexeme{`err`, 26, 29, 0, symbol.IDENTIFIER_EXPLICIT},
