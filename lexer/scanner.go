...
func ScanLine(line string, lineNum int) (ls []symbol.Lexeme, lxErr LexError) {
...
// - literal number
func numLex(itr *runer.RuneItr) (l *symbol.Lexeme, err LexError) {
...
// - go function call
func sourceryLex(itr *runer.RuneItr) (s *symbol.Lexeme, err LexError) {
...
// - string literal
func strLex(itr *runer.RuneItr) (l *symbol.Lexeme, err LexError) {
...
// - range generator
func symbolLex(itr *runer.RuneItr) (l *symbol.Lexeme, err LexError) {
