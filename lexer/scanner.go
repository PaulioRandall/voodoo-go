...
func wordSym(itr *runer.RuneItr) *symbol.Symbol {
...
// - literal number
func numSym(itr *runer.RuneItr) (s *symbol.Symbol, err LexError) {
...
func spaceSym(itr *runer.RuneItr) *symbol.Symbol {
...
// - go function call
func sourcerySym(itr *runer.RuneItr) (s *symbol.Symbol, err LexError) {
...
// - string literal
func strSym(itr *runer.RuneItr) (s *symbol.Symbol, err LexError) {
...
// - comment
func commentSym(itr *runer.RuneItr) *symbol.Symbol {
...
func otherSym(itr *runer.RuneItr) (s *symbol.Symbol, err LexError) {
