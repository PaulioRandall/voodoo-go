	...
	return []symArrayTest{
		...
		symArrayTest{
			...
			Expects: []Symbol{
				...
				Symbol{`[`, 8, 9, 0, SQUARE_BRACE_OPEN},
				Symbol{`"Whelp"`, 9, 16, 0, STRING},
				Symbol{`]`, 16, 17, 0, SQUARE_BRACE_CLOSE},
			},
		},
		symArrayTest{
			...
			Expects: []Symbol{
				...
				Symbol{`(`, 16, 17, 0, CIRCLE_BRACE_OPEN},
				Symbol{`a`, 17, 18, 0, VARIABLE},
				Symbol{`,`, 18, 19, 0, VALUE_SEPARATOR},
				Symbol{` `, 19, 20, 0, WHITESPACE},
				Symbol{`b`, 20, 21, 0, VARIABLE},
				Symbol{`)`, 21, 22, 0, CIRCLE_BRACE_CLOSE},
				Symbol{` `, 22, 23, 0, WHITESPACE},
				Symbol{`r`, 23, 24, 0, VARIABLE},
				Symbol{`,`, 24, 25, 0, VALUE_SEPARATOR},
		...
		symArrayTest{
			...
			Expects: []Symbol{
				...
				Symbol{`:`, 16, 17, 0, KEY_VALUE_SEPARATOR},
		...
		symArrayTest{
			...
			Expects: []Symbol{
				...
				Symbol{`<-`, 9, 11, 0, ASSIGNMENT},
				Symbol{` `, 11, 12, 0, WHITESPACE},
				Symbol{`[`, 12, 13, 0, SQUARE_BRACE_OPEN},
				Symbol{`"a"`, 13, 16, 0, STRING},
				Symbol{`,`, 16, 17, 0, VALUE_SEPARATOR},
				Symbol{` `, 17, 18, 0, WHITESPACE},
				Symbol{`"b"`, 18, 21, 0, STRING},
				Symbol{`,`, 21, 22, 0, VALUE_SEPARATOR},
				Symbol{` `, 22, 23, 0, WHITESPACE},
				Symbol{`"c"`, 23, 26, 0, STRING},
				Symbol{`]`, 26, 27, 0, SQUARE_BRACE_CLOSE},
			},
		},
		symArrayTest{
			Input: `loop i <- 0..5`,
		...
		symArrayTest{
			...
			Expects: []Symbol{
				...
				Symbol{`(`, 8, 9, 0, CIRCLE_BRACE_OPEN},
