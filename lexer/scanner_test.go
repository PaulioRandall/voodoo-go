	...
	return []symArrayTest{
		...
		symArrayTest{
			...
			Expects: []sym.Symbol{
				...
				sym.Symbol{`(`, 16, 17, 0, sym.CIRCLE_BRACE_OPEN},
				...
				sym.Symbol{`)`, 21, 22, 0, sym.CIRCLE_BRACE_CLOSE},
		...
		symArrayTest{
			...
			Expects: []sym.Symbol{
				...
				sym.Symbol{`(`, 8, 9, 0, sym.CIRCLE_BRACE_OPEN},
				...
				sym.Symbol{`)`, 14, 15, 0, sym.CIRCLE_BRACE_CLOSE},
			},
		},
		symArrayTest{
			Input: `!x => y <- _`,
